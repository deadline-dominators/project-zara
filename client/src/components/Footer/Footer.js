...
function Footer() {
  return (
    ...
    //             <p className='footerTitles'>Exclusive</p>
    //             <p>Subscribe</p>
    ...
    //             <li className='footerTitles'>Support</li>
    //             <li>111 Bijoy sarani, Dhaka,<br/> DH 1515, Bangladesh.</li>
    //             <li>exclusive@gmail.com</li>
    //             <li>+88015-88888-9999</li>
    //         </div>
    //         <div className='section3'>
    //             <li className='footerTitles'>Account</li>
    //             <li>My Account</li>
    ...
    //             <li className='footerTitles'>Quick Link</li>
    ...
    //             <p className='footerTitles'>Download App</p>
    //             <p>Save $3 with App New User Only</p>
    //             <div>
    //                 <img src={CodeQR} style={{'width':'77px'}} />
    //                 <div>
    //                 <img src={GooglePlay}  width={'77px'}/>
    //                 <img src={AppStore} width={'77px'}/>
    //                 </div>
    //             </div>
    //             <div>
